...
namespace Lean.Change
{
    ...
    /// Ftp帮助类
    /// </summary>
    public class Helper_Folder
    {
        #region 属性
        private Helper_FtpClient ftp;
        /// <summary>
        /// 全局FTP访问变量
        /// </summary>
        public Helper_FtpClient Ftp
        {
            get { return ftp; }
            set { ftp = value; }
        }
        ...
        ///得到FTP传输对象
        /// </summary>
        public Helper_FtpClient getFtpClient()
        {
            Helper_FtpClient ft = new Helper_FtpClient();
