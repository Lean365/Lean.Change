...
namespace Lean.Change
{
    ...
    public class Helper_FtpClient
    {
        ...
        /// 构造函数
        /// </summary>
        public Helper_FtpClient(string remoteHost, string remotePath, string remoteUser, string remotePass, int remotePort)
        {
